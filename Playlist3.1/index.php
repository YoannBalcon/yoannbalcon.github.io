          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/inscription/sendInscription.php" method="post">
                ...
                <input type="password" placeholder="Mot de passe" name="password" value=""><br>
                <input type="password" placeholder="Confirmation du mot de passe" name="password_confirm" value=""><br>
                <input type="email" placeholder="Adresse email" name="email" value=""><br>
