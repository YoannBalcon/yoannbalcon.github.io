        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/createPlaylist/playlistCreation.php" method="post">
                <input type="text" placeholder="Nom de la playlist" name="playlistName" value=""><br>
      ...
      <div id="newTrackModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/addTrack/ajouter.php" method="post" enctype="multipart/form-data">
